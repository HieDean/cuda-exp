...
int bmm_v3_2_16(const float *A, const float *B, float *C,
                int bs, int m, int n, int k, cudaStream_t stream);
int bmm_v3_4_8(const float *A, const float *B, float *C,
               int bs, int m, int n, int k, cudaStream_t stream);
// int bmm_v3_8_4(const float *A, const float *B, float *C,
//                int bs, int m, int n, int k, cudaStream_t stream);
// int bmm_v3_16_2(const float *A, const float *B, float *C,
//                 int bs, int m, int n, int k, cudaStream_t stream);
...
int bmm_v52(const float *A, const float *B, float *C,
           int bs, int m, int n, int k, cudaStream_t stream);

int bmm_v6(const float *A, const float *B, float *C,
           int bs, int m, int n, int k, cudaStream_t stream);

int bmm_v7(const float *A, const float *B, float *C,
           int bs, int m, int n, int k, cudaStream_t stream);